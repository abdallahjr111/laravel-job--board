...
<div class="space-y-12">
    ...
    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="mt-2">
            ...
            class=" {{ $errors->has('body') ? 'outline-red-500' : 'outline-black/10' }} block w-full rounded-md bg-black/5 px-3 py-1.5 text-base text-black outline-1 -outline-offset-1 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">{{ old('body') }}</textarea>
        </div>
